...
HD_PWD='/users/tareelou/git_neural/neural_network_simul/neural_network_simul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tree_reduction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tree_reduction.tcl
